...
def main():
    ...
    # print("Real function for control: ", np.cross([0., 0., 1.], [1., 0., 0.]))
    print("-" * 50) 

    u = Vector([[1., 2., 3.]])
    v = Vector([[4., 5., 6.]])
    print(Vector.cross_product(u, v)) # [-3.][6.][-3.]
    # print("Real function for control: ", np.cross([1., 2., 3.], [4., 5., 6.]))
    print("-" * 50) 

    u = Vector([[4., 2., -3.]]);
    v = Vector([[-2., -5., 16.]]);
    print(Vector.cross_product(u, v)); # [17.][-58.][-16.]
    # print("Real function for control: ", np.cross([4., 2., -3.], [-2., -5., 16.]))
    print("-" * 50)
